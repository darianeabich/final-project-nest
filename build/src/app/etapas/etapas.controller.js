...
var EtapasController = /** @class */ (function () {
    ...
    EtapasController.prototype.index = function (page, limit) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.etapasService.findAll({ page: page, limit: limit, route: 'http://localhost:3000/etapas' })];
            });
        });
    };
    EtapasController.prototype.show = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.etapasService.findOneOrFail({ where: { id: id } })];
            });
        });
    };
    // @Role('admin')
    EtapasController.prototype.store = function (createEtapaDto) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.etapasService.store(createEtapaDto)];
            });
        });
    };
    // @Role('admin')
    ...
    EtapasController.prototype.destroy = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.etapasService.destroy(id)];
    ...
    ], EtapasController.prototype, "index", null);
    __decorate([
        (0, common_1.Get)(':id'),
        ...
        __metadata("design:returntype", Promise)
    ], EtapasController.prototype, "show", null);
    __decorate([
        (0, common_1.Post)(),
        ...
        __metadata("design:returntype", Promise)
    ], EtapasController.prototype, "store", null);
    __decorate([
        (0, common_1.Put)(':id'),
        __param(0, (0, common_1.Param)('id')),
        __param(1, (0, common_1.Body)()),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Number, update_etapa_dto_1.UpdateEtapaDto]),
        __metadata("design:returntype", Promise)
    ], EtapasController.prototype, "update", null);
    __decorate([
        ...
        __metadata("design:paramtypes", [Number]),
        __metadata("design:returntype", Promise)
    ], EtapasController.prototype, "destroy", null);
