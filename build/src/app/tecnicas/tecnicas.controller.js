...
var TecnicasController = /** @class */ (function () {
  ...
  TecnicasController.prototype.store = function (createTecnicaDto) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.tecnicasService.create(createTecnicaDto)];
          case 1:
  ...
  TecnicasController.prototype.indexAll = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.tecnicasService.findAllWithoutPage()];
          case 1:
            return [2 /*return*/, _a.sent()];
        }
      });
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.tecnicasService.findOneOrFail({ where: { id: id } }),
            ];
          case 1:
            return [2 /*return*/, _a.sent()];
        }
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [
              4 /*yield*/,
              this.tecnicasService.update(+id, updateTecnicaDto),
            ];
          case 1:
            return [2 /*return*/, _a.sent()];
        }
  ...
  TecnicasController.prototype.destroy = function (id) {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            return [4 /*yield*/, this.tecnicasService.remove(+id)];
          case 1:
            return [2 /*return*/, _a.sent()];
        }
      });
  ...
  __decorate(
    [
      ...
      __metadata('design:paramtypes', [
        Number,
        update_tecnica_dto_1.UpdateTecnicaDto,
      ]),
      __metadata('design:returntype', Promise),
    ],
    TecnicasController.prototype,
