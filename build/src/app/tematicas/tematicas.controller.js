...
var TematicasController = /** @class */ (function () {
    ...
    TematicasController.prototype.index = function (page, limit) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.tematicasService.findAll({ page: page, limit: limit, route: 'http://localhost:3000/tematicas' })];
            });
        });
    };
    TematicasController.prototype.findOne = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.tematicasService.findOneOrFail({ where: { id: id } })];
            });
        });
    };
    TematicasController.prototype.create = function (createTematicaDto) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.tematicasService.store(createTematicaDto)];
            });
        });
    };
    TematicasController.prototype.update = function (id, updateTematicaDto) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.tematicasService.update(+id, updateTematicaDto)];
            });
        });
    };
    TematicasController.prototype.remove = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.tematicasService.destroy(+id)];
            });
        });
    };
    __decorate([
    ...
    ], TematicasController.prototype, "index", null);
    __decorate([
        (0, common_1.Get)(':id'),
        ...
        __metadata("design:returntype", Promise)
    ], TematicasController.prototype, "findOne", null);
    __decorate([
        (0, common_1.Post)(),
        __param(0, (0, common_1.Body)()),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [create_tematica_dto_1.CreateTematicaDto]),
        __metadata("design:returntype", Promise)
    ], TematicasController.prototype, "create", null);
    __decorate([
        (0, common_1.Put)(':id'),
        __param(0, (0, common_1.Param)('id')),
        __param(1, (0, common_1.Body)()),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", [Number, update_tematica_dto_1.UpdateTematicaDto]),
        __metadata("design:returntype", Promise)
    ], TematicasController.prototype, "update", null);
    __decorate([
        ...
        __metadata("design:paramtypes", [Number]),
        __metadata("design:returntype", Promise)
    ], TematicasController.prototype, "remove", null);
